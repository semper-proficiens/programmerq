            ...
            <Container>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="mx-auto">
                        ...
                        >
                            <NavDropdown.Item href="#action/3.1" className="text-light bg-dark"><span>DailyProgrammer</span><div className="dropdown-divider dark"></div></NavDropdown.Item>
                    ...
                    <Nav className="ml-auto">
                        <NavDropdown
                            title={
                                <span>
                                    <span className="text-primary">M</span>ore
                                </span>
                            }
                            id="basic-nav-dropdown"
                            className="nav-link-dropdown"
